...
protocol PopUpItem {
    ...
    var identifier: NSInteger { get set }
}
...
class PopUp<T: RawRepresentable>: UIViewController,
                                  UITableViewDelegate,
    ...
    lazy var footerView: UIButton = {
        ...
        button.backgroundColor = UIColor("#EBEBEB")
    ...
    typealias PopUpHandler = ((PopUpItem) -> Void)
    typealias PopUpEnumeratedHandler = ((T) -> Void)
    typealias PopUpStringHandler = ((String) -> Void)
    ...
    init(title: String, items: [T], handler: @escaping PopUpEnumeratedHandler) {
        ...
        for (index, item) in items.enumerated() {
            ...
            let newPopUpItem = PopUpBaseItem(title: title, identifier: index)
    ...
    init(style: PopUpStyle,
         items: [String],
         configurations: [PopUpConfiguratiuons] = [],
         handler: @escaping PopUpStringHandler) {
        super.init(nibName: nil, bundle: nil)
        setImmediateDefaults()
        ...
        for (index, item) in items.enumerated() {
            let newPopUpItem = PopUpBaseItem(title: item, identifier: index)
            popUpItems.append(newPopUpItem)
        }
    ...
    func addTitleToTableView(title: String?) {
        ...
        case .cancelEnabled(title: _):
            ...
            popUpTitleLabel.backgroundColor = UIColor("#EBEBEB")
        }
